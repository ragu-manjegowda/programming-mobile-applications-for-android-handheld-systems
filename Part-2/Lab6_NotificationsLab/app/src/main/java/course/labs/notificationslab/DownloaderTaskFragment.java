...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		downloaderTask.execute(bundle.getIntegerArrayList(MainActivity.TAG_FRIEND_RES_IDS));
					...
					new BroadcastReceiver() {
						...
						public void onReceive(Context context, Intent intent) {
							...
							if (getResultCode() != MainActivity.IS_ALIVE) {
								...
								// Definimos la actividad a la cual el usuario accederá
								// si éste pulsa sobre la notificación, lo hacemos mediante
								// la creación de un PendingIntent.
								...
								// Añadimos el texto successMsg a la vista personalizada que
								// se usará en esta notificación.
								...
								// Creamos la notificación mediante el uso de un Notification.Builder.
								// Añadimos cierta información, como el icono y demás.
								...
								// Una vez configuradas todas las opciones de la notificación
								// la generamos llamando al método notify() del NotificationManager,
								// al cual podemos acceder mediante una llamada a getSystemService()
								// con la constante Context.NOTIFICATION_SERVICE.
								// Por otra parte, al método notify() le pasamos como parámetro el
								// identificador único que hemos definido para nuestra notificación
								// y el resultado del builder mediante el método build().
